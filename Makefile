...
#    Updated: 2021/02/23 20:23:38 by jleem            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_CUSTOM	= $(addprefix $(SRCDIR), ft_islower_bonus.c ft_isupper_bonus.c ft_isspace_bonus.c ft_make_array_bonus.c ft_free_array_bonus.c ft_array_push_bonus.c ft_array_pop_bonus.c ft_strcmp_bonus.c ft_free_split_bonus.c ft_strcpy_bonus.c ft_strcat_bonus.c)
